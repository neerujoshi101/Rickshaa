...
const PrivacyPolicy = (props) => {
  ...
  console.log('--------------privacy', privacy?.contents)
 ...
 const getAllCategory = async() => {
  ...
  ApiModel.sendApiCall(
    ...
    null,
    response => {
      console.log('------------HELP&SUPPORT', privacy?.contents)
      setIsLoading(false);
  ...
  return (
    ...
    {/* <ScrollView contentContainerStyle={{}}> */}
        ...
        <View style={{height:'20%', width:'100%'}}>
            <Image resizeMode="contain" source={Images.privacyPolicy} style={{height:'100%', width:'100%'}}/> 
        </View>

        <Text style={[Textstyles.bold, {width: "95%", marginVertical:vh(2), alignSelf: "center", fontSize: 28, color: Colors.black}]}>
          Your trust is importatnt to us
        </Text>
